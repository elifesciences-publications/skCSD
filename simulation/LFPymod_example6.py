...
if not os.path.isfile('/media/BA0ED4600ED416EB/agy/ksCSD_2014/trunk/simulation/morphology/Mainen96_LFPy/patdemo/cells/j4a.hoc'):
    #get the model files:
...
os.system('''
          cd /media/BA0ED4600ED416EB/agy/ksCSD_2014/trunk/simulation/morphology/Mainen96_LFPy/patdemo
          nrnivmodl
          ''')

#os.system('nrnivmodl')
LFPy.cell.neuron.load_mechanisms('/media/BA0ED4600ED416EB/agy/ksCSD_2014/trunk/simulation/morphology/Mainen96_LFPy/patdemo')
...
cellParameters = {
    'morphology' : '/media/BA0ED4600ED416EB/agy/ksCSD_2014/trunk/simulation/morphology/L5_Mainen96_wAxon_LFPy.hoc',
...
cell.set_rotation(0,0.1047198,0.3490659)
...
#directory = '/media/BA0ED4600ED416EB/agy/LFPy_examples/out_Dori'
#if not os.path.exists(directory):
#    os.makedirs(directory)
#os.chdir(directory)

np.savetxt( 'membcurr',cell.imem)
np.savetxt('vmem',cell.vmem)
